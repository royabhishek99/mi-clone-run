...
const searchIcon=<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" 
fill="none"/><path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 
    ...
    return (
        <div className='nav'>
            <div className='logo'>
                ...
                <Link className='navlinks' to="/laptops">Laptopns</Link>
                <Link className='navlinks' to="/fitnessandlifestyle">Fitness & Lifestyle</Link>
